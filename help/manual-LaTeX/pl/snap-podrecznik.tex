...
\chapter{Pierwszoklasowe listy}

Typ danych nazywamy \emph{pierwszoklasowym} w~danym języku programowania, jeśli dana tego typu może być:

\begin{itemize}
\item wartością zmiennej,
\item parametrem procedury,
\item wartością zwróconą z~funkcji,
\item członem złożonej struktury danych,
\item daną anonimową (bez nadanej nazwy).
\end{itemize}
